...
System link: https://my313815.s4hana.ondemand.com/ui#Shell-home   

1. **User name:** You have been given a card with a number on it. This corresponds to your user. The naming for the users is as follows: `tester0<##>_shPal26@example.com`. Enter your number into the placeholder. For example, if you have card 80: `tester080_shPal26@example.com`
2. **Password:** `Helper-NT-2026!`   
